          ...
          >
            ...
            <div className="relative z-10 flex flex-col">
              ...
              <h1 className="m-0 text-white font-[850] text-[clamp(28px,4vw,42px)] leading-tight tracking-[-1px] mb-4">
                Media <span className="text-[#18d4ff]">Enquiry</span>
              </h1>
              <p className="m-0 text-white/70 text-[16px] leading-relaxed mb-9">
                Apply for media accreditation to cover breakthrough announcements, interview global technology pioneers, and share the stories defining Southeast Asia&apos;s AI decade.
              </p>

              {/* Hubspot Form Embedded Container */}
              <HubspotForm portalId="2953901" formId="cc694ad6-290f-4dee-8dee-0863b628709f" />
            </div>
