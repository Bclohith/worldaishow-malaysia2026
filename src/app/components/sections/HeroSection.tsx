...
export function HeroSection() {
  return (
    <section className="hero-bg relative min-h-[720px] -mt-[102px] grid place-items-center overflow-hidden text-center max-[980px]:min-h-[680px] max-sm:-mt-[71px] max-sm:min-h-[720px]" id="home">
      {/* Background Video */}
      <video
      ...
      {/* Hero Content */}
      <div className="container relative z-2 mx-auto px-6 pt-[231px] max-sm:pt-[180px] max-sm:px-4 flex flex-col items-center">
        {/* Glow Status Pill */}
        ...
        {/* Hero CTA Actions */}
        <div className="flex justify-center flex-wrap gap-3 mt-[32px] mb-16 max-sm:mb-10 max-sm:flex-col max-sm:items-center max-sm:gap-4 max-sm:w-full max-sm:max-w-[280px]">
          ...
          <Button variant="outline" href="/malaysia/partners#floor-plan">Enter 3D Experience</Button>
        </div>
      </div>
